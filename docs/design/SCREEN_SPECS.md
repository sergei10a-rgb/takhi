...
2. **Саналын бэлэн байдлын мэдэгдэл** (`NoticeCard`) — хуудасны хамгийн эхэнд, үргэлж харагдана. Дөрвөн төлөв:
   - нэр огт бичээгүй → шавар, `driverProfileOfferBlockedNameNotice`;
   - нэр бичсэн ч **хадгалаагүй** → алт, `driverProfileOfferBlockedUnsavedNotice`;
   - нэр хадгалсан, зураг алга → шавар, `driverProfileOfferBlockedPhotoNotice`;
   - бүгд бүрэн → хээрийн ногоон, `driverProfileOfferReadyNotice`.

   ⚠️ Бэлэн/бэлэн бус эсэхийг `driverOfferBlock` цөмийн функц шийднэ — `OfferService.sendOffer` яг үүнийг хэрэглэдэг. Асуух утга нь **хадгалсан** нэр ба хадгалсан зураг, талбарт бичсэн текст **биш**: санал нь `driver_inbox_page.dart`-д `loadLocalProfile`-оос барагддаг тул хадгалаагүй нэр саналд огт очихгүй. Талбарын текстээр шүүсэн мэдэгдэл «бэлэн» гэж худал хэлэх байсан.
3. **«Таны зураг»** хэсэг (`driverProfilePhotoSectionTitle`, тайлбар `driverProfilePhotoRequiredHint`):
   - дугуй урьдчилан харагдац (`DriverPhotoPreview`, 132dp) — зураггүй бол хүний дүрсний placeholder;
   - **«Камераар авах»** (`driverProfileTakePhotoAction`) ба **«Галерейгаас сонгох»** (`driverProfileChoosePhotoAction`) — хоёулаа бүтэн өргөн, `image_picker`;
   - татгалзсан бол шавар өнгийн `NoticeCard` — `driverPhotoRejected*` зургаан мөрийн аль нэг, эсвэл зөвшөөрөл/авах/хадгалахын алдаа (`driverProfilePhoto*Hint`);
   - **ил тайлбар** (`driverProfilePhotoNotProofDisclaimer`, тэнгэрийн өнгө): шалгалт нь зөвхөн «зурган дотор хүний царай байна уу» гэдгийг хэлнэ, «энэ яг тэр хүн мөн» гэдгийг **батлахгүй**.
4. **«Таны нэр»** хэсэг (`driverProfileNameSectionTitle`): **«Овог»** (`driverProfileFamilyNameFieldLabel`) ба **«Нэр»** (`driverProfileNameFieldLabel`). Хоёулаа `driverNamePartProblem`-оор шалгагдаж, буруу бол талбарынхаа доор `driverNameProblem*` шалтгаанаа бичнэ.
5. **«Машин»** хэсэг: **«Машины загвар»** (`driverProfileCarFieldLabel`), **«Өнгө»** (`driverProfileColorFieldLabel`), **«Улсын дугаар»** (`driverProfilePlateFieldLabel`).
6. **«Үнэ»** хэсэг — метертэй аяллын үнэ тогтоох **гурван бие даасан тариф**, бүгд тоон гар:
   - **«Км-тариф (₮/км)»** (`driverProfileKmTariffFieldLabel`) — ГАНЦ заавал бөглөх тариф (`_RequiredAnswer.kmTariff`): үүнгүйгээр метерийн санал огт бүтэхгүй;
   - **«Түгжрэл/зогсолтын тариф (₮/мин)»** (`driverProfileWaitTariffFieldLabel`) — зогссон минут тутам;
   - **«Аяллын хугацааны тариф (₮/мин)»** (`driverProfileDurationTariffFieldLabel`) — эхний GPS цэгээс сүүлчийнх хүртэлх минут тутам, явж байсан ч, зогссон ч.

   ⚠️ Сүүлийн хоёр нь **санаатайгаар давхцана**: зогссон секунд аяллын хугацаанд бас багтдаг тул хоёуланг нь тавьсан жолооч тэр секундыг хоёр удаа тооцно. Энэ бол жолоочийн өөрийнх нь арилжааны шийдвэр (зохиогчийн шийдвэр, 2026-08-01) — апп үүнийг хориглохгүй, сануулга ч харуулахгүй, хослолыг нь албадахгүй.

   ⚠️ Хоёр минутын тариф хоосон байвал = «энэ хөлс үнэгүй» гэсэн БҮРЭН хариулт, дутуу бөглөсөн маягт биш. Тэгээс ялгаатай нь: 0-ээр хадгалсан тарифыг дахин нээхэд талбар **хоосон** гарч ирнэ (`initState`) — хүсээгүй 0 нь «хэн нэгэн зориуд тавьсан үнэ» мэт уншигддаг.

   Метерийн өөрийн тарифын маягт (S17) ижил гурван тарифыг тохируулдаг ч **өөр хадгалах сан** руу бичдэг (`TariffStore`, энд `DriverProfileStore`). Тиймээс шошго нь санаатайгаар өөр үгтэй: энд «...тариф», метер дээр «Түгжрэл/зогсолт», «Аяллын хугацаа». Яг ижил үг байвал жолооч нэгийг нь бөглөөд нөгөөг нь бөглөсөн гэж эндүүрнэ.
7. **«Хадгалах»** үндсэн товч (`saveDriverProfileAction`), доод `TakhiSheet`-д бэхлэгдсэн.

Хуудас нээгдмэгц өмнө хадгалсан профайл болон зураг локалаас уншигдаж талбарууд **урьдчилан бөглөгдөнө** (`initState`).

⚠️ **Овог, нэр, зураг гурав relay-д ХЭЗЭЭ Ч нийтлэгдэхгүй.** kind-0 нь нийтэд нээлттэй бөгөөд мөнхөд хуулбарлагддаг тул тэнд тавьсан царайг хэн ч улсын дугаар, амьд geohash-тай нь хамт цуглуулж чадна. Эдгээр нь зөвхөн NIP-17 gift-wrap саналаар, тухайн нэг зорчигч руу очно. Relay руу зөвхөн машин, өнгө, дугаар, тариф явна (`buildDriverProfile`-д `name:` параметр байхгүй).

⚠️ **Зураг = хаалт, баталгаа БИШ.** Найз, алдартан, интернетээс авсан танихгүй хүний зураг, дэлгэц дээрээс дахин авсан зураг — бүгд шалгалтыг давна (liveness илрүүлэлт байхгүй). Клиент талын шалгалт тул засварласан build алгасаж чадна. Иймд UI дээрх ил тайлбар нь чимэглэл биш, зайлшгүй шаардлага.
...
- **Зураг шалгаж буй:** `_checkingPhoto` үед хоёр сонгох товч **идэвхгүй** болж, доор нь `driverProfilePhotoCheckingLabel` гарна. Хоёр дахь сонголт нэгдүгээрийнхээ дээгүүр орж хадгалалт руу уралдахаас сэргийлнэ.
- **Хоосон:** анх удаа орж буй жолоочид бүх талбар хоосон, дугуй зураг хоосон, «Хадгалах» **идэвхгүй**, бэлэн байдлын мэдэгдэл нэр дутууг зааж байна. Гэхдээ хүрээгүй талбарт улаан «Заавал бөглөнө» **гарахгүй** — шинэ маягтыг зэмлэхгүй; шаардлагыг дээд талын мэдэгдэл л хэлнэ.
- **Зургийн татгалзал:** зургаан шалтгаан тус бүр **өөр өөр өгүүлбэртэй** (`DriverPhotoRejection`). Тэдгээр нь өөр өөр биет үйлдлээр засагддаг тул нийтлэг «алдаа гарлаа» болгож нэгтгэхийг хориглоно. Татгалзсан зураг өмнөх сайн зургийг **арилгахгүй**.
- **Хадгалах алдаа:** relay-д нийтлэх бүтэлгүйтвэл хэрэглэгчид харагдахгүй (профайлын хэсэгт хэвээр). Зураг дискэнд бичигдэхгүй бол `driverProfilePhotoSaveFailedHint` гарна.
- **Зөвшөөрөл:** камер/галерейн зөвшөөрөл татгалзвал `driverProfilePhotoPermissionDeniedHint` гарна. AndroidManifest-д `android.permission.CAMERA`-г **зориудаар зарлаагүй** — `image_picker` нь ACTION_IMAGE_CAPTURE intent ашигладаг тул зөвшөөрөл шаардахгүй, харин зарлачихвал Android нь runtime-д олгогдтол тэр intent-ийг `SecurityException`-оор татгалзаж, ажиллаж байсан урсгалыг эвдэнэ. Зарласан зүйл нь `uses-feature ... required="false"` — камергүй төхөөрөмжид апп суумтгай хэвээр байх ёстой (галерейгаас сонгож болно).
